...
error_business_org_emp_self_update_delete = {
    ...
    'message' : 'You are not allowed to update or delete yourself from Organization!'
}

error_business_org_ops_found = {
    'code' : 'businessOrgOpsFound',
    'message' : 'The registration number you entered already exists in our iDukaan app. Please double-check the registration number and try again. If you need further information or assistance, we recommend raising a request for more information.'
}

error_business_org_ops_not_found = {
    'code' : 'businessOrgOpsNotFound',
    'message' : 'Organization do not have inter-state operations. Please add GSTIN for connecting with shops.'
}